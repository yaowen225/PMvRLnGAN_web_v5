...
class DRLAgent:
    ...
    def get_model(
        ...
        print("Get Model kwargs: " ,model_kwargs)
    ...
    def DRL_prediction(model, environment, deterministic=True):
        ...
        for i in range(len(environment.df.index.unique())):
            ...
            if i == (len(environment.df.index.unique()) -2): 
                ...
                balance_memory = test_env.env_method(method_name="save_balance_memory")

            if dones[0]:
                print("hit end!")
                break
        return account_memory[0], actions_memory[0], balance_memory[0]
